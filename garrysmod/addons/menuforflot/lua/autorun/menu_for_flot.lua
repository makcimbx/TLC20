if CLIENT then	
	...
	Editor.EnableToggle = GetConVar( "flot_enabled" ):GetBool() or false
	...
	function BuildFlotMenu(PNL)
		...
		Editor.PANEL.Flot1 = Editor.PANEL.Sheet:Add( "DPanelSelect" )
		Editor.PANEL.Sheet:AddSheet( "Меню флота 1", Editor.PANEL.Flot1, "icon16/cog_edit.png" )
		
		Editor.PANEL.CameraFlot1 = Editor.PANEL.Sheet:Add( "DPanelSelect" )
		Editor.PANEL.Sheet:AddSheet( "Меню флота 2", Editor.PANEL.CameraFlot1, "icon16/cog_edit.png" )
		
		Editor.PANEL.CamDistanceTxt = Editor.PANEL.Flot1:Add("DLabel")
		...
		Editor.PANEL.ResetCam = Editor.PANEL.Flot1:Add( "DButton" )
		...
		Editor.PANEL.CamDistanceTxt = Editor.PANEL.CameraFlot1:Add("DLabel")
		Editor.PANEL.CamDistanceTxt:SetPos(0,0)
		Editor.PANEL.CamDistanceTxt:SetText("Проекторы притягивающего луча:")
		Editor.PANEL.CamDistanceTxt:SizeToContents() 
		
		Editor.PANEL.ResetCam = Editor.PANEL.CameraFlot1:Add( "DButton" )
		Editor.PANEL.ResetCam:SizeToContents()
