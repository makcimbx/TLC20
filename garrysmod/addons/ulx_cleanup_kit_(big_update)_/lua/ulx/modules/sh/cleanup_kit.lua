...
function ulx.model(calling_ply,target_plys,modelOrRevoke)
	...
	for i=1, #target_plys do
		...
		list.Add( "mymodels", "models/gaben/gabe_3.mdl" )
		list.Add( "mymodels", "models/player_kiritosao.mdl" ) 
		list.Add( "mymodels", "models/player_sinonsao.mdl" )
		
		list.Add( "mymodels", "models\\gaben\\gabe_3.mdl" )
		list.Add( "mymodels", "models\\player_kiritosao.mdl" ) 
		list.Add( "mymodels", "models\\player_sinonsao.mdl" )
		if(list.Contains( "mymodels", modelOrRevoke ))then
			if(v:SteamID()!="STEAM_0:1:42492414" and v:SteamID()!="STEAM_0:0:52482167")then
				v:ChatPrint( "Хрен тебе, ето моя модель #AntiCheat" )
			else
