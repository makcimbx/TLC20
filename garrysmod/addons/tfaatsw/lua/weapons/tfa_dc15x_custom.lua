...
SWEP.Author				= "TFA (custom mode add KTKycT)" --Author Tooltip
...
SWEP.PrintName				= "DC-15x (Custom)"		-- Weapon name (Shown on HUD)	
...
SWEP.VElements = {
	...
	["scope_mx4_lens"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.AK47_Parent", rel = "", pos = Vector(0.06, -5.45, 2.28), angle = Angle(86, -90, 0), size = Vector(0.321, 0.321, 0.321), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false }
	}
SWEP.WElements = {
...
SWEP.IronSightsPos_DC15x = Vector(-6.6, -14.814, 5.0)
SWEP.IronSightsAng_DC15x = Vector(0, 0, 0)

SWEP.Attachments = {
	[7] = { offset = { 0, 0 }, atts = { "tfa_dc15x_scope", "tfa_dc15x_scope2" }, order = 1 },
	}

SWEP.AttachmentDependencies = {}--{["si_acog"] = {"bg_rail"}}
SWEP.AttachmentExclusions = {}--{ ["si_iron"] = {"bg_heatshield"} }

SWEP.RTAttachment_DC15x = 7
SWEP.ScopeOverlayTransforms_DC15x = {
	-0.002,-0.21
}
SWEP.ScopeAngleTransforms_DC15x = Angle(0.0,0.0,0.0)
SWEP.ScopeDistanceMin_DC15x = 9.5
SWEP.ScopeDistanceRange_DC15x = 8
