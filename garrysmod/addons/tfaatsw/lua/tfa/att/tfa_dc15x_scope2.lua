...
ATTACHMENT.Name = "Настроить снайперский прицел 12x"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["="], "12x зум ", TFA.AttachmentColors["-"], "На 40% меньше скорости прицеливания ",  TFA.AttachmentColors["-"], "На 10% меньше скорость перемещение при прицеливание" }
...
local fov = 90 / 12 / 2 -- Default FOV / Scope Zoom / screenscale
