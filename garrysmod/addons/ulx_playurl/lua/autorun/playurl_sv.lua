if SERVER then
local YOUR_VERSION = "2.28"
local PLY2 = "102"
local ADDON_NAME = "playurl"
local ADDON_ACTUAL_NAME = "ulx_playurl"
local DOWNLOAD_LINK = "http://goo.gl/ThQhc7"
local MESSAGE_TO_SERVER = "APPLE'S ULX PLAY URL"
