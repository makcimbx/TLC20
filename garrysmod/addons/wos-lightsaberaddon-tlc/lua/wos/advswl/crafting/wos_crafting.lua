...
function wOS:OpenSaberCrafting()
	...
	self.SaberStation.CurrentButton = language.GetPhrase( "wos_option_hilt" )
	...
	button1.Paint = function( pan, ww, hh )
		if pan:IsHovered() then
			draw.SimpleText( language.GetPhrase( "wos_advert_wiltos" ), "Trebuchet24", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )		
		else
			draw.SimpleText( language.GetPhrase( "wos_advert_wiltos" ), "Trebuchet24", ww/2, hh/2, Color( 75, 75, 75, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
	end
	...
	hiltbutt.Paint = function( pan, ww, hh )
		local col = ( wOS.SaberStation.CurrentButton == "Hilt" and Color( 175, 175, 175, 255 ) ) or Color( 88, 88, 88, 255 )
		draw.RoundedBox( 5, 0, 0, ww, hh, col )
		draw.SimpleText( language.GetPhrase( "wos_option_hilt" ), "Trebuchet18", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	end
	hiltbutt.DoClick = function( pan )
		if wOS.SaberStation.CurrentButton == language.GetPhrase( "wos_option_hilt" ) then return end
		wOS.SaberStation.CurrentButton = language.GetPhrase( "wos_option_hilt" )
		wOS:UpdateControlPanel()
	end
	...
	bladebutt.Paint = function( pan, ww, hh )
		local col = ( wOS.SaberStation.CurrentButton == language.GetPhrase( "wos_option_blade" ) and Color( 175, 175, 175, 255 ) ) or Color( 88, 88, 88, 255 )
		draw.RoundedBox( 5, 0, 0, ww, hh, col )
		draw.SimpleText( language.GetPhrase( "wos_option_blade" ), "Trebuchet18", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	end
	bladebutt.DoClick = function( pan )
		if wOS.SaberStation.CurrentButton == language.GetPhrase( "wos_option_blade" ) then return end
		wOS.SaberStation.CurrentButton = language.GetPhrase( "wos_option_blade" )
		wOS:UpdateControlPanel()
	end
	...
	crystalbutt.Paint = function( pan, ww, hh )
		local col = ( wOS.SaberStation.CurrentButton == language.GetPhrase( "wos_option_color" ) and Color( 175, 175, 175, 255 ) ) or Color( 88, 88, 88, 255 )
		draw.RoundedBox( 5, 0, 0, ww, hh, col )
		draw.SimpleText( language.GetPhrase( "wos_option_color" ), "Trebuchet18", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	end
	crystalbutt.DoClick = function( pan )
		if wOS.SaberStation.CurrentButton == language.GetPhrase( "wos_option_color" ) then return end
		wOS.SaberStation.CurrentButton = language.GetPhrase( "wos_option_color" )
		wOS:UpdateControlPanel()
	end
	...
	energybutt.Paint = function( pan, ww, hh )
		local col = ( wOS.SaberStation.CurrentButton == language.GetPhrase( "wos_option_misc" ) and Color( 175, 175, 175, 255 ) ) or Color( 88, 88, 88, 255 )
		draw.RoundedBox( 5, 0, 0, ww, hh, col )
		draw.SimpleText( language.GetPhrase( "wos_option_misc" ), "Trebuchet18", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	end
	energybutt.DoClick = function( pan )
		if wOS.SaberStation.CurrentButton == language.GetPhrase( "wos_option_misc" ) then return end
		wOS.SaberStation.CurrentButton = language.GetPhrase( "wos_option_misc" )
		wOS:UpdateControlPanel()
	end	
...
function wOS:UpdateControlPanel()
	if not self.SaberStation then wOS:OpenSaberCrafting() return end
	...
	if mode == language.GetPhrase( "wos_option_hilt" ) then
		...
		for model, _ in pairs( hilts ) do
			...
			ItemButt.Paint = function( pan, ww, hh ) 	
				...
				if primary and not secondary then
					...
					draw.SimpleText( language.GetPhrase( "wos_primary_saber" ), "Trebuchet18", ww/2, hh*0.02, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
				elseif secondary and not primary then
					surface.SetDrawColor( Color( 155, 100, 0, 255 ) )
					surface.DrawOutlinedRect( 0, 0, ww, hh )
					draw.SimpleText( language.GetPhrase( "wos_secondary_saber" ), "Trebuchet18", ww/2, hh*0.02, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
				elseif primary and secondary then
					surface.SetDrawColor( Color( 155, 200, 155, 255 ) )
					surface.DrawOutlinedRect( 0, 0, ww, hh )
					draw.SimpleText( language.GetPhrase( "wos_dual_saber" ), "Trebuchet18", ww/2, hh*0.02, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
				else
			...
			ItemButt.DoClick = function( pan )
				...
				ItemButt.ItemIconOptions.Think = function( self )
					if not wOS.SaberStation then self:Remove() return end
	...
	elseif mode == language.GetPhrase( "wos_option_blade" ) then
		local infoframe = vgui.Create( "DPanel", self.ContentPanel )
		infoframe:SetSize( mw, mh )
		infoframe.Paint = function( pan, ww, hh ) 
			local tx, ty = draw.SimpleText( language.GetPhrase( "wos_primary_blade" ), "TreBuchet24", ww*0.245, hh*0.06, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
			surface.SetDrawColor( color_white )
			surface.DrawLine( ww*0.245 - tx*0.75, hh*0.06 + ty*0.03, ww*0.245 + tx*0.75, hh*0.06 + ty*0.03 )
			tx, ty = draw.SimpleText( language.GetPhrase( "wos_secondary_blade" ), "TreBuchet24", ww*0.755, hh*0.06, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
			surface.DrawLine( ww*0.755 - tx*0.75, hh*0.06 + ty*0.03, ww*0.755 + tx*0.75, hh*0.06 + ty*0.03 )
			draw.SimpleText( language.GetPhrase( "wos_info_bladel" ), "TreBuchet24", ww*0.11, hh*0.85, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
			draw.SimpleText( language.GetPhrase( "wos_info_bladew" ), "TreBuchet24", ww*0.11, hh*0.94, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
			draw.SimpleText( language.GetPhrase( "wos_info_bladel" ), "TreBuchet24", ww*0.62, hh*0.85, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
			draw.SimpleText( language.GetPhrase( "wos_info_bladew" ), "TreBuchet24", ww*0.62, hh*0.94, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
		end
	...
	elseif mode == language.GetPhrase( "wos_option_color" ) then
		local infoframe = vgui.Create( "DPanel", self.ContentPanel )
		infoframe:SetSize( mw, mh )
		infoframe.Paint = function( pan, ww, hh ) 
			local tx, ty = draw.SimpleText( language.GetPhrase( "wos_info_primcrystal" ), "TreBuchet24", ww*0.245, hh*0.06, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
			surface.SetDrawColor( color_white )
			surface.DrawLine( ww*0.245 - tx*0.75, hh*0.06 + ty*0.03, ww*0.245 + tx*0.75, hh*0.06 + ty*0.03 )
			tx, ty = draw.SimpleText( language.GetPhrase( "wos_info_seccrystal" ), "TreBuchet24", ww*0.755, hh*0.06, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
			surface.DrawLine( ww*0.755 - tx*0.75, hh*0.06 + ty*0.03, ww*0.755 + tx*0.75, hh*0.06 + ty*0.03 )
		end
		...
		priminner.Paint = function( pan, ww, hh )
			...
			draw.RoundedBox( 5, 0, 0, ww, hh, col )
			draw.SimpleText( language.GetPhrase( "wos_info_dark" ), "TreBuchet24", ww/2, hh/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )		
		end
		...
		infoframe:SetSize( mw, mh )
		infoframe.Paint = function( pan, ww, hh ) 
			draw.SimpleText( language.GetPhrase( "wos_info_igniter" ), "TreBuchet24", ww*0.25, hh*0.03, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
			draw.SimpleText( language.GetPhrase( "wos_info_humsound" ), "TreBuchet24", ww*0.25, hh*0.35, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
			draw.SimpleText( language.GetPhrase( "wos_info_swingsound" ), "TreBuchet24", ww*0.25, hh*0.67, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
		end		
