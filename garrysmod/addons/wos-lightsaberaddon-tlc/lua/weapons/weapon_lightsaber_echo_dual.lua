...
SWEP.PrintName = "Echo Dual Lightsabers" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_echo_dual" --The file name of this swep
...
SWEP.UseLength = 54 -- Length of the saber 
SWEP.UseWidth = 3 -- Width of the saber
SWEP.UseColor = Color( 145, 145, 145 ) -- RGB Color of saber. Red = Color( 255, 0, 0 ) Blue = Color( 0, 0, 255 ), etc.
...
SWEP.UseSecHilt = "models/sgg/starwars/weapons/w_maul_saber_half_hilt.mdl"
