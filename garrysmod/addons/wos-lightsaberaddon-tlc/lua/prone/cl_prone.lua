...
hook.Add( "CalcViewModelView", "prone.ViewTransitions", function(weapon, viewModel, oldEyePos, oldEyeAngles, eyePos, eyeAngles)
	...
	client.nutRaisedFrac = Lerp(FrameTime(), client.nutRaisedFrac or 0, value)
	...
	local animstate = client:GetProneAnimationState()
	
	if animstate == PRONE_GETTINGDOWN || animstate == PRONE_GETTINGUP then
		oldEyePos = transitionVector
	end
