...
function JukeBox.VGUI.Pages.QuickRequest:CreatePanel( parent )
	...
	parent.Description:SetText( JukeBox.Lang:GetPhrase( "#SEARCH_Description" ) )
	...
	parent.Scroll.SearchForSong = function()
		...
		function( body )
			...
			if not (type( info ) == "table") then
				parent.Scroll.Issue = JukeBox.Lang:GetPhrase( "#SEARCH_UnexpectedError" )
				return
			end
			if table.Count( info ) >= 1 then
				...
				parent.Scroll.Issue = JukeBox.Lang:GetPhrase( "#SEARCH_NoResults" )
			end
		end,
		function( issue )
			if not ValidPanel( parent.Scroll ) then return end
	...
	parent.Scroll.AddVideoCard = function( parent, info )
		...
		card.Buttons.View.DoClick = function( self )
			...
			local dropdownVoteButton = dropdown:AddOption( JukeBox.Lang:GetPhrase( "#SEARCH_InPopup" ) )
			...
			dropdown:AddSpacer()
			local dropdownForceButton = dropdown:AddOption( JukeBox.Lang:GetPhrase( "#SEARCH_InSteamOverlay" ) )
		...
		card.Buttons.View.Paint = function( self, w, h )
			...
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#SEARCH_ViewVideo" ), "JukeBox.Font.16", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
		end
		...
		card.Buttons.AddSong.Paint = function( self, w, h )
			...
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#SEARCH_AddSong" ), "JukeBox.Font.16", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
		end
...
function JukeBox.VGUI.Pages.QuickRequest:CheckURL( parent, id )
	...
	popup.TopBar.Paint = function( self, w, h )
		draw.RoundedBox( 0, 0, 0, w, h, JukeBox.Colours.Base )
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#HEADING_Name" ).." - "..JukeBox.Lang:GetPhrase( "#SEARCH_CheckURL" ), "JukeBox.Font.18", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
	end
	...
	popup.HTML.PaintOver = function( self, w, h )
		...
		if self.Progress == 1 then
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#MANUAL_CheckingURL" ), "JukeBox.Font.20", w/2, h*0.25, Color( 255, 255, 255 ), 1, 1 )
			JukeBox.VGUI.VGUI:DrawEmblem( w/2, h/2-10, 80, "jukebox/loading.png", Color( 255, 255, 255 ), -CurTime()*100 )
		elseif self.Progress == 2 then
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#MANUAL_VideoExists" ), "JukeBox.Font.20", w/2, h*0.25, Color( 255, 255, 255 ), 1, 1 )
			JukeBox.VGUI.VGUI:DrawEmblem( w/2, h/2-10, 80, "jukebox/tick.png", Color( 255, 255, 255 ), 0 )
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#SEARCH_LengthCheck", self.LengthString, self.Length ), "JukeBox.Font.20", w/2, h*0.75, Color( 255, 255, 255 ), 1, 1 )
		elseif self.Progress == 3 then
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#MANUAL_VideoNotExists" ), "JukeBox.Font.20", w/2, h*0.25, Color( 255, 255, 255 ), 1, 1 )
			JukeBox.VGUI.VGUI:DrawEmblem( w/2, h/2-10, 80, "jukebox/cross.png", Color( 255, 255, 255 ), 0 )
		elseif self.Progress == 4 then
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#MANUAL_ErrorWithServer" ), "JukeBox.Font.20", w/2, h*0.25, Color( 255, 255, 255 ), 1, 1 )
...
function JukeBox.VGUI.Pages.QuickRequest:AddSongPopup( parent, data2 )
	...
	popup.TopBar.Paint = function( self, w, h )
		draw.RoundedBox( 0, 0, 0, w, h, JukeBox.Colours.Base )
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#HEADING_Name" ).." - "..JukeBox.Lang:GetPhrase( "#TAB_AddSong" ), "JukeBox.Font.18", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
	end
	...
	popup.EditArea.NamePanel.Paint = function( self, w, h )
		...
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#HEADING_Song" )..":", "JukeBox.Font.18", 5, h/2, Color( 255, 255, 255 ), 0, 1 )
	end
	...
	popup.EditArea.ArtistPanel.Paint = function( self, w, h )
		draw.RoundedBox( h/2, 138, 0, w-138, h, Color( 255, 255, 255 ) )
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#HEADING_Artist" )..":", "JukeBox.Font.18", 5, h/2, Color( 255, 255, 255 ), 0, 1 )
	end
	...
	popup.EditArea.URLPanel.Paint = function( self, w, h )
		...
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#SEARCH_YouTubeID" )..":", "JukeBox.Font.18", 5, h/2, Color( 255, 255, 255 ), 0, 1 )
	end	
	...
	popup.EditArea.URLCheck.Paint = function( self, w, h )
		...
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#SEARCH_CheckYouTubeID" ), "JukeBox.Font.16", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
	end
	...
	popup.EditArea.TimePanel.Paint = function( self, w, h )
		...
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#HEADING_Length" )..":", "JukeBox.Font.18", 5, 24/2, Color( 255, 255, 255 ), 0, 1 )
	end
	...
	function popup.EditArea.TimePanel.Checks()
		if popup.EditArea.TimeSecsEntry:GetValue()+popup.EditArea.TimeMinsEntry:GetValue()*60 > 0 then
			if popup.EditArea.TimeSecsEntry:GetValue()+popup.EditArea.TimeMinsEntry:GetValue()*60 > JukeBox.Settings.MaxSongLength then
				popup.EditArea.TimeSecsEntry.Issue1 = true
				popup.EditArea.TimeMinsEntry.Issue1  = true
			else
			...
			http.Fetch( JukeBox.Settings.CheckerURL..popup.EditArea.URLEntry.URLID, 
				function( body )
					...
					elseif info.videoExists then
						...
						if IsValid( popup ) and IsValid( popup.EditArea ) then
	...
	popup.EditArea.StartTimePanel.Paint = function( self, w, h )
		--draw.RoundedBox( h/2, 0, 0, w, h, Color( 255, 0, 255 ) )
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#MANUAL_StartTime" )..":", "JukeBox.Font.18", 5, 24/2, Color( 255, 255, 255 ), 0, 1 )
	end
	...
	popup.EditArea.EndTimePanel.Paint = function( self, w, h )
		--draw.RoundedBox( h/2, 0, 0, w, h, Color( 255, 0, 255 ) )
		draw.SimpleText( JukeBox.Lang:GetPhrase( "#MANUAL_EndTime" )..":", "JukeBox.Font.18", 5, 24/2, Color( 255, 255, 255 ), 0, 1 )
	end
	...
	popup.EditArea.ActionButtons.Cancel.Text = JukeBox.Lang:GetPhrase( "#BUTTON_Cancel" )
	...
	function popup.EditArea.DisplayIssues( words )
		local text = JukeBox.Lang:GetPhrase( "#MANUAL_IssueWithFields", "\n"..words )
		...
		newpopup.TopBar.Paint = function( self, w, h )
			draw.RoundedBox( 0, 0, 0, w, h, JukeBox.Colours.Base )
			draw.SimpleText( JukeBox.Lang:GetPhrase( "#HEADING_Name" ).." - "..JukeBox.Lang:GetPhrase( "#SEARCH_Error" ), "JukeBox.Font.18", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
		end
		...
		newpopup.CancelButton.Text = JukeBox.Lang:GetPhrase( "#BUTTON_Close" )
	...
	function popup.EditArea.AcceptPopup( data, oldbg )
		...
		popup.BottomButton.SetSend = function()
			popup.BottomButton.Text = JukeBox.Lang:GetPhrase( "#SEARCH_SubmitRequest" )
			popup.BottomButton.DoClick = function()
		...
		elseif JukeBox.Settings.RequestFasttrack then
			...
			popup.BottomButton2.DoClick = function()
				JukeBox.VGUI.Pages.QuickRequest:FasttrackPage( parent, data, bg, oldbg )
			end
			popup.BottomButton2.Paint = function( self, w, h )
				if JukeBox.VGUI.VGUI:GetHovered( self ) then
					draw.RoundedBox( h/2, 0, 0, w, h, JukeBox.Colours.Definition )
...
function JukeBox.VGUI.Pages.QuickRequest:FasttrackPage( parent, data, other, other2 )
	local bg = vgui.Create( "DFrame" )
	bg:SetSize( ScrW(), ScrH() )
	bg:Center()
	bg:SetTitle( " " )
...
JukeBox.VGUI:RegisterPage( "#TAB_AddSong", "QuickRequest", "#TAB_Search", "jukebox/search.png", function( parent ) JukeBox.VGUI.Pages.QuickRequest:CreatePanel( parent ) end )