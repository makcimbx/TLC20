...
function JukeBox.VGUI.Pages.AdminRequests:CreatePanel( parent )
	...
	function parent.EditArea.TimePanel.Checks()
		if parent.EditArea.TimeSecsEntry:GetValue()+parent.EditArea.TimeMinsEntry:GetValue()*60 > 0 then
			if parent.EditArea.TimeSecsEntry:GetValue()+parent.EditArea.TimeMinsEntry:GetValue()*60 > JukeBox.Settings.MaxSongLength then
				parent.EditArea.TimeSecsEntry.Issue1 = true
				parent.EditArea.TimeMinsEntry.Issue1  = true
			else
	...
	parent.EditArea.ActionButtons.Accept.Paint = function( self, w, h )
		...
		draw.SimpleText( "Add Song", "JukeBox.Font.20", h+10, h/2, Color( 255, 255, 255 ), 0, 1 )
	end
...
function JukeBox.VGUI.Pages.AdminRequests:CreateSongCard( parent, info )
	...
	card.Paint = function( self, w, h )
		...
		draw.SimpleText( JukeBox:MinWord( info.name, "JukeBox.Font.20", w-10-(w-(w/2.5))-20 ), "JukeBox.Font.20", 10, h/2, Color( 255, 255, 255 ), 0, 1 )
		draw.SimpleText( JukeBox:MinWord( info.artist, "JukeBox.Font.20", w-10-(w/2.5)-(w-(w*0.75))-20 ), "JukeBox.Font.20", w/2.5, h/2, Color( 255, 255, 255 ), 0, 1 )
	...
	card.EditButton.Paint = function( self, w, h )
		...
		draw.SimpleText( "View/Edit", "JukeBox.Font.20", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
	end
...
function JukeBox.VGUI.Pages.AdminRequests:DenyPopup( parent )
	...
	popup.CancelButton.Paint = function( self, w, h )
		...
		draw.SimpleText( "Cancel", "JukeBox.Font.20", w/2, h/2, Color( 255, 255, 255 ), 1, 1 )
	end
