...
REWARDS.Settings.SteamGroupPage = "http://steamcommunity.com/groups/CWRPPR"
...
REWARDS.Settings.GroupName = "CWRPPR"
...
REWARDS.NoticePrefix = "[TLC]" --Chat notification prefix
REWARDS.JoinButtonText = "Присоединитесь к Steam Группе" --Text on join button
REWARDS.DontJoinButtonText = "Не сейчас" --Text on don't join (Close) button
--Message box text (e.g. explain the rewards of joining your group)
REWARDS.Settings.RewardsMessage = "Присоединитесь сейчас и получите 10000 опыта!"
--Message box text on success (e.g. explain what rewards we're given)
REWARDS.Settings.RewardsSuccessMessage = "Спасибо за присоединение к группе!"
--Message box text on check (e.g. explain that a check is happening)
REWARDS.Settings.RewardsJoinCheckMessage = "Проверяем ваше участие в группе..."
...
REWARDS.Settings.RewardsChatMessage = "Присоединился к нашей группе!"
--You can set the FKeyShowCursor to F1,F2,F3 or F4 and change to "" to disable FKeyShowCursor
REWARDS.Settings.FKeyShowCursor = "F3" --Useful for gamemodes with no cursor key
...
--Example
REWARDS.Settings.CustomRewardFunction = function(ply) ply:addXP(10000) end