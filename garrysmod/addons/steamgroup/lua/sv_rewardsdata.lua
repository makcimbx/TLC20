...
--
REWARDS.Database = {}
REWARDS.Database.Host = 'server191.hosting.reg.ru' -- MySQL host/server IP
REWARDS.Database.Username = 'u0426341_gmod' -- MySQL username
REWARDS.Database.Password = 'vstreza555' -- MySQL password
REWARDS.Database.DatabaseName = 'u0426341_gmod' -- MySQL database
