...
SWEP.Primary.Sound 					= Sound ("Weapon_DC17.Single");
...
SWEP.IronSightsPos = Vector(-4.75, -1.5, 1.5)
SWEP.IronSightsAng = Vector(0.1, 0.25, 0)
...
SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/SW_Battlefront/Weapons/dc17_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1, -1.3), angle = Angle(-8, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
