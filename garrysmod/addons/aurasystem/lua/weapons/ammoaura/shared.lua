...
if timer.RepsLeft( "AM2CD" ..self.Owner:UserID() ) != nil or timer.RepsLeft( "AM3CD" ..self.Owner:UserID() ) != nil then
...
timer.Create( "AMCD" ..self.Owner:UserID(), 1, 45, function () end) else return end
end
end
...
function SWEP:Think()
self.Cd = timer.RepsLeft( "AMCD" ..self.Owner:UserID() )
self.Activeskil = timer.RepsLeft( "AMdeploy" ..self.Owner:UserID() )
...
function SWEP:DrawHUD()	
	...
	surface.SetMaterial(Material( "skilliconammoraura.png" ))
