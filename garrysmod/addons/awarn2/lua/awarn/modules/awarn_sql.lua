local awarn_mysql_config = {
	EnableMySQL			=	true,
	Host				=	"server191.hosting.reg.ru", --Host IP
	Username			=	"u0426341_gmod",
	Password			=	"vstreza555",
	Database_name		=	"u0426341_gmod", --Existing database on the MYSQL server
	Database_port		=	3306,
...
AWarn.ServerKey = "Main Server" --Edit this to your liking. If you run multiple servers using the same database, this is how you can identify which warnings came from which server.
