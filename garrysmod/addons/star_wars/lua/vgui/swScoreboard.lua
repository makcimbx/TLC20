...
function PANEL:Paint(w , h)
    ...
    draw.SimpleTextOutlined("TLC" , lowRes and "sw_ui_24" or "sw_ui_32" , w / 2 , lowRes and 16 or 36 , Color(0 , 150 , 0) , TEXT_ALIGN_CENTER , TEXT_ALIGN_CENTER , 1 , Color(0 , 79 , 0))
    ...
    draw.SimpleText("Имя Игрока" , "sw_ui_18b" , initialRow , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Имя Игрока" , "sw_ui_18" , initialRow , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Убийств" , "sw_ui_18b" , initialRow + rowSize , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Убийств" , "sw_ui_18" , initialRow + rowSize , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Смертей" , "sw_ui_18b" , initialRow + rowSize * 2 , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Смертей" , "sw_ui_18" , initialRow + rowSize * 2 , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Работа" , "sw_ui_18b" , initialRow + rowSize * 3 , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Работа" , "sw_ui_18" , initialRow + rowSize * 3 , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Пинг" , "sw_ui_18b" , initialRow + rowSize * 4 , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
    draw.SimpleText("Пинг" , "sw_ui_18" , initialRow + rowSize * 4 , bannerTop , Color(176 , 226 , 235) , TEXT_ALIGN_LEFT , TEXT_ALIGN_CENTER)
