...
SWEP.CrouchRecoilMultiplier=0.001  --Multiply recoil by this factor when we're crouching.  This is proportional, not inversely.
...
SWEP.CrouchAccuracyMultiplier=0.001 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
SWEP.JumpAccuracyMultiplier=1.9--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
