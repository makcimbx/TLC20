...
SWEP.Primary.Spread			= 0.0020
SWEP.Primary.IronAccuracy = 0.0001	-- Ironsight accuracy, should be the same for shotguns .0005
...
SWEP.JumpAccuracyMultiplier=2.7--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
