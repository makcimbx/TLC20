...
SWEP.PrintName				= "DC-15X"		-- Weapon name (Shown on HUD)	
...
--Misc
SWEP.IronRecoilMultiplier=0.1 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
SWEP.ProceduralReloadTime = 5 --Time to take when procedurally reloading, including transition in (but not out)
