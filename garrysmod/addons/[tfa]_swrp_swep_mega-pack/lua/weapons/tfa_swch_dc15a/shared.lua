...
SWEP.Primary.Spread			= 0.0028
SWEP.Primary.IronAccuracy = .0004	-- Ironsight accuracy, should be the same for shotguns SWEP.Primary.Spread			= 0.0028 SWEP.Primary.IronAccuracy = .0004
