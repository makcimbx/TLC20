...
SWEP.Primary.Spread		= .0650					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.0005	-- Ironsight accuracy, should be the same for shotguns .0005
...
SWEP.WallRecoilMultiplier=1.5  --Multiply recoil by this factor when we're changing state e.g. not completely ironsighted.  This is proportional, not inversely.
