SWEP.Gun					= ("tfa_voxel_dlt19") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "DLT19"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound 			= Sound("weapons/synbf3/dlt19_fire.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.CrouchAccuracyMultiplier=0.250--Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
SWEP.ViewModel			= "models/weapons/synbf3/c_dlt19.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/synbf3/w_dlt19.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.28, -6.231, 1.049)
