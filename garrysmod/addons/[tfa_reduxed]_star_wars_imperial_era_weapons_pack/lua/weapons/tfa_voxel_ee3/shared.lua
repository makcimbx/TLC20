SWEP.Gun					= ("tfa_voxel_ee3") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "EE-3M"		-- Weapon name (Shown on HUD)
...
--Misc
SWEP.IronRecoilMultiplier=0.010 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchRecoilMultiplier=0.085  --Multiply recoil by this factor when we're crouching.  This is proportional, not inversely.
...
SWEP.CrouchAccuracyMultiplier=0.0055--Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
SWEP.IronSightsPos = Vector(-3.457, 1, 2.23)
