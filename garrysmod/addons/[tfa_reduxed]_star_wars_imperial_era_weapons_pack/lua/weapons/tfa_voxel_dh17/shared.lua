SWEP.Gun					= ("tfa_voxel_dh17") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "DH-17"		-- Weapon name (Shown on HUD)
...
SWEP.IronSightsPos = Vector(-4.205, 2, 1.8)
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0.01, 4.185, 04.58), angle = Angle(0, 270, 180), size = Vector(0.299, 0.299, 0.299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
