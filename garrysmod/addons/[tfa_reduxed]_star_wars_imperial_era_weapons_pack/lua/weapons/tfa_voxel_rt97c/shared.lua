...
SWEP.PrintName				= "RT-97C Heavy Blaster Rifle"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.ReloadSound = Sound ("weapons/synbf3/RT97C_reload.wav");
...
SWEP.ViewModel			= "models/weapons/synbf3/c_RT97C.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/synbf3/w_RT97C.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector (9.329, -4.222, -0.611) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector (0, 29.548, 0) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-2.52, -12.865, 2.609)
...
SWEP.Tracer				= "vox_sw_laser_red"		--Bullet tracer.  TracerName overrides this.
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_rt97c_reference001", rel = "", pos = Vector(0, 18.405, 5.98), angle = Angle(0, 90, 180), size = Vector(.340, .340, .340), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
