SWEP.Gun					= ("tfa_voxel_dlt20a") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "DLT20-A"		-- Weapon name (Shown on HUD)
...
--Range Related
SWEP.Primary.Range = 100000000000 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.ViewModel			= "models/weapons/synbf3/c_dlt20a.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/synbf3/w_dlt20a.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector (9.289, -4.222, -0.611) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector (-4.926, 29.548, 0) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-4.08, 0, 2.279)
...
SWEP.ProceduralReloadTime = 10 --Procedural reload time?
...
SWEP.TracerName 		= "vox_sw_laser_green" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.VElements = {
	["rt scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt20a_reference001", rel = "", pos = Vector(0, 4.636, 6.175), angle = Angle(0, 90, 180), size = Vector(0.31, 0.31, 0.31), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
...
SWEP.RTCode = function( self, mat )
	...
	if AngPos then
		...
		ang:RotateAroundAxis(ang:Up(), 0.0)
