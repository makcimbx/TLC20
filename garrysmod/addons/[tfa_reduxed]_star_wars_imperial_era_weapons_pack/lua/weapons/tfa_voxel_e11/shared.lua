SWEP.Gun					= ("tfa_voxel_e11") --Make sure this is unique.  Specically, your folder name.
...
SWEP.Primary.Sound 			= Sound("weapons/synbf3/e11_fire.wav")				-- This is the sound of the weapon, when you shoot.
...
-- RT SCOPES --
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "E11", rel = "", pos = Vector(-1.25, -3.45, 4.629), angle = Angle(0, 90, 180), size = Vector(0.3299, 0.3299, 0.3299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
