SWEP.Gun					= ("tfa_voxel_t21") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "T-21"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("weapons/synbf3/T21_fire.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Spread		= .0100					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0001	-- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 2.25 --How far the spread can expand when you shoot.
...
--Range Related
SWEP.Primary.Range = nil -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.CrouchAccuracyMultiplier=0.005--Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
...
SWEP.IronSightsPos = Vector(-2.455, -6.231, 1.586)
...
SWEP.MuzzleFlashEnabled = false --NEW VARIABLE IS SWEP.MuzzleFlashEnabled
