...
SWEP.PrintName				= "A280"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound 			= Sound("weapons/synbf3/a280_fire.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/synbf3/c_a280.mdl" --Viewmodel path
...
-- RT SCOPES --
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "A280", rel = "", pos = Vector(-0.1, -02.0, 06.65), angle = Angle(360, 90, 180), size = Vector(0.299, 0.299, 0.299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
...
SWEP.WorldModel			= "models/weapons/synbf3/w_a280.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.92, 2, 1.3)
