SWEP.Gun					= ("tfa_voxel_dl44") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "DL-44"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/synbf3/c_dl44.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/synbf3/w_dl44.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector (6.619, -6.829, -11.66) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-4.401, -6.231, 2.099)
...
SWEP.ProceduralReloadTime = 6 --Procedural reload time?
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dl44_reference001", rel = "", pos = Vector(1.5, 2.5, 3.73), angle = Angle(0, -90, 180), size = Vector(0.3299, 0.3299, 0.3299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
