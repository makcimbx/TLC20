SWEP.Gun					= ("tfa_voxel_t-21b") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "T-21B"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound = Sound ("weapons/synbf3/T21_fire.wav");
...
SWEP.ViewModel			= "models/weapons/synbf3/c_t21.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/synbf3/w_t21.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector (10.2,-11.055,3.940) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector (-14.070,26.734,0) --Change this, using SWEP Creation Kit preferably
...
SWEP.WElements = {
	["B"] = { type = "Model", model = "models/swbf3/outerrim/weapons/t-21b.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(12, 1, 1.6), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.VElements = {
	
	["models/swbf3/outerrim/weapons/t-21b.mdl"] = { type = "Model", model = "models/swbf3/outerrim/weapons/t-21b.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.518, 8.831, -2.597), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
