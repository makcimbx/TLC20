SWEP.Gun					= ("tfa_voxel_se14c") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "SE-14c"		-- Weapon name (Shown on HUD)
...
--Range Related
SWEP.Primary.Range = 100000 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 100 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
...
SWEP.IronSightsPos = Vector(-4.421, -5.628, 1.814)
