...
SWEP.IronSightsPos = Vector(-5.1, 0, 1.87)
SWEP.IronSightsAng = Vector(2.65, 0.15, 0)
...
SWEP.VElements = {
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dlt19_reference001", rel = "dc15le", pos = Vector(-1.48, 0, 4.45), angle = Angle(0, -180, 0), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["dc15le"] = { type = "Model", model = "models/sw_battlefront/weapons/dc15a_rifle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.79, -2, 2), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 1} }
}

SWEP.WElements = {
	["dc15"] = { type = "Model", model = "models/SW_Battlefront/Weapons/dc15a_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.1, -1.4), angle = Angle(-8, 0, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 1} }
}
...
SWEP.ScopeReticule_Scale 			= {1.35,1.35}
if surface then
