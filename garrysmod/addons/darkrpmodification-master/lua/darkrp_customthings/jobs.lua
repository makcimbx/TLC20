...
TEAM_GCSNP = DarkRP.createJob("41-й Снайпер", {
	color = Color(62, 126, 52, 255),
	model = "models/smitty/bf_gc/gc_trooper.mdl",
...
TEAM_74TRP = DarkRP.createJob("74-й Солдат", {
	...
	weapons = {"tfa_dc15a_custom_medicvar","tfa_dc17chrome","first_aid_kit","weapon_physgun","weapon_physcannon","defibrillator","clone_card_c5"},
	command = "74trp",
	max = 0,
	level = 10,
	salary = 50,
...
TEAM_74CPL = DarkRP.createJob("74-й Капрал", {
	...
	weapons = {"tfa_dc15a_custom_medicvar","tfa_dc17chrome","first_aid_kit","weapon_physgun","weapon_physcannon","defibrillator"},
	command = "74cpl",
	max = 0,
	salary = 70,
	level = 20,
...
TEAM_74SGT = DarkRP.createJob("74-й Сержант", {
	...
	weapons = {"tfa_dc15a_custom_medicvar","tfa_dc17chrome","first_aid_kit","weapon_physgun","weapon_physcannon","defibrillator","clone_card_c6"},
	command = "74sgt",
	max = 0,
	level = 30,
	salary = 80,
...
TEAM_74LT = DarkRP.createJob("74-й Лейтенант", {
	...
	weapons = {"tfa_dc15a_custom_medicvar","tfa_dc17chrome","first_aid_kit","weapon_physgun","weapon_physcannon","defibrillator","clone_card_c7"},
	command = "74lt",
	max = 0,
	salary = 100,
	level = 40,
...
TEAM_74CO = DarkRP.createJob("74-й Командир", {
	...
	weapons = {"tfa_dc15a_custom_medicvar","tfa_dc17chrome","first_aid_kit","weapon_physgun","weapon_physcannon","defibrillator","clone_card_c8","weapon_physgun"},
	command = "74co",
	max = 0,
	level = 1,
	salary = 500,
...
TEAM_ARCGRENADE = DarkRP.createJob("ЭРК Гранатометчик", {
	...
	model = "models/gonzo/swbf2arc/arcblue/arcblue.mdl",
	description = [[Поздравляем, теперь вы Элитный Разведывательный Коммандос!]],
	weapons = {"tfa_swch_clonelauncher", "tfa_dc17dual_custom", "zeus_smokegranade", "zeus_flashbang", "zeus_thermaldet", "seal6-c4","clone_card_c5"},
	command = "arcgrenade",
	max = 0,
	salary = 75,
	level = 20,
...
TEAM_ARCGUNNER = DarkRP.createJob("ЭРК Пулеметчик", {
	...
	model = "models/gonzo/swbf2arc/arcblue/arcblue.mdl",
	description = [[Поздравляем, теперь вы Элитный Разведывательный Коммандос!]],
	weapons = {"tfa_swch_z6", "tfa_dc17dual_custom", "zeus_smokegranade", "zeus_flashbang", "zeus_thermaldet", "seal6-c4","clone_card_c5"},
	command = "arcgunner",
	max = 0,
	salary = 75,
	level = 30,
...
TEAM_ENSIN = DarkRP.createJob("Энсин", {
	...
	weapons = {"tfa_dc17chrome","clone_card_c3nevy","weapon_lightsaber_training"},
	command = "ensin",
	max = 0,
	salary = 750,
	level = 10,
...
model = {
	...
	description = [[.]],
	weapons = {"gmod_tool","clone_card_c5"},
	command = "youngling",
	max = 0,
	category = "Jedi",
	salary = 0,
...
TEAM_YODA = DarkRP.createJob("Йода", {
	...
	maxHP=2000,
	maxAM=100,
	PlayerLoadout = function(ply) ply:SetModelScale(0.6, 1) end,
	vote = false,
	category = "Jedi",
	candemote = false,
})
...
TEAM_TANO = DarkRP.createJob("Асока", {
	...
	maxHP=2000,
	maxAM=100,
	PlayerLoadout = function(ply) ply:SetModelScale(0.9, 1) end,
	vote = false,
	category = "Jedi",
	candemote = false,
})
