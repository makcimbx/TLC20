-- Credit for all of this to HandsomeMatt

-- Found from https://facepunch.com/showthread.php?t=1434130
-- Slightly modified for some personal fun
...
vgui.Register( "ModernEscapeAvatar", PANEL )
